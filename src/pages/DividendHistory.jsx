...
const DividendHistory = () => {
  ...
  // Ensure dividend history data has string years for the chart
  const formattedDividendHistory = stock.dividendHistory.map(item => ({
    ...item,
    year: String(item.year) // Convert year to string to match chart requirements
  }));
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="glass-card mb-6">
          ...
          <CardContent>
            ...
            <DividendHistoryChart data={formattedDividendHistory} />
